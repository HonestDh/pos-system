    ...
    <div className="flex-1 overflow-y-auto p-5 bg-gray-50">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-5 text-sm text-gray-600">
          <div className="font-bold text-gray-800 mb-2">ℹ️ Как это работает</div>
          <ul className="space-y-1.5 list-disc pl-5">
            <li>Программа сама проверяет обновления при запуске и раз в 6 часов.</li>
            <li>Для проверки и загрузки нужен интернет.</li>
            <li>Загрузка не мешает работе — касса продолжает принимать заказы.</li>
            <li>
              Если загруженное обновление не установить кнопкой, оно поставится
              само при закрытии программы.
            </li>
            <li>Товары, настройки принтера и история продаж при обновлении не теряются.</li>
          </ul>
        </div>
      </div>
    </div>
